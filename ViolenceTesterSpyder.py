...
#In another csv file called violentposts
    ...
    output.to_csv("C://Users//lisa//OneDrive//Desktop//violenceDetector//ViolenceDetector//labeled_data.csv", index=False)
...
#Write a loop to iterate through each image in folder & label    
    ...
    df = pd.read_csv ('C://Users//lisa//OneDrive//Desktop//violenceDetector//ViolenceDetector//scraped_images.csv')
    ...
    savefile = df4.to_csv('C://Users//lisa//OneDrive//Desktop//violenceDetector//ViolenceDetector//photoslinks.csv',index=False)
    savefile
...
# urls.csv is set to your current working directory make sure your cd into or add the corresponding path
    with open ('C://Users//lisa//OneDrive//Desktop//violenceDetector//ViolenceDetector//photoslinks.csv') as images:
    ...
    folder_dir = 'C:\\Users\\lisa\\OneDrive\\Desktop\\violenceDetector\\ViolenceDetector'
    for images in os.listdir(folder_dir):
        if images.endswith('.jpg'):
            ...
            results.print()
            #results.show()
            results.xyxy[0]  # im predictions (tensor  # im predictions (tensor

    sourcepath='C:\\Users\\lisa\\OneDrive\\Desktop\\violenceDetector\\ViolenceDetector\\'
    sourcefiles = os.listdir(sourcepath)
    destinationpath = 'C:\\Users\\lisa\\OneDrive\\Desktop\\violenceDetector\\ViolenceDetector\\imageFolder'
    for files1 in sourcefiles:
        if files1.endswith('.jpg'):
           shutil.move(os.path.join(sourcepath,files1), os.path.join(destinationpath,files1))
...
elif event == 'Detect Corpus':
    labelTextTweet()
elif event == 'Detect Images':
    labelImage()
elif event == 'Cancel':
    exit()
